...
function renderLogin() {
  return '<div class="center"><div class="card login-card"><div style="text-align:center;margin-bottom:1rem"><div class="login-logo"><img src="/logo.svg" alt="OmniBot"/></div><div style="font-size:1.25rem;font-weight:700">OmniBot</div></div><p class="help">Manage your server, add OmniBot, or appeal a punishment. You will sign in with Discord when needed.</p><button class="btn" id="btnOpenDashboard" style="width:100%;margin-bottom:.75rem">Open Dashboard</button><a class="btn ghost" style="display:block;margin-bottom:.75rem" href="' + INVITE + '" target="_blank" rel="noopener">Add to Discord</a><button class="btn ghost" id="btnAppealPunishment" style="width:100%">Appeal a punishment</button><p class="status" style="margin-top:1rem">API: same-origin · <a href="/health" target="_blank">/health</a></p><p class="status" style="margin-top:.75rem"><a href="/tos">Terms of Service</a> · <a href="/privacy-policy">Privacy Policy</a></p></div></div>';
}
