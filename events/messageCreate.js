...
console.log(
    ...
    translationSettings
        ...
        const automod =
            database.automod?.[message.guild.id];
        ...
        if (automod?.enabled) {
            ...
            const hasInvite =
                /discord(?:\.gg|\.com\/invite)\/[a-z0-9-]+/i
                ...
                try {
                    ...
                    const warning =
                        await message.channel.send({
                            content:
                                `⚠️ ${message.author}, your message was removed by AutoMod.`
                        });
                        ...
                        await sendModLog(
                            message.guild,
                            {
                                title:
                                    "🔇 Anti-Spam Timeout",
                                description:
                                    `${message.author} was automatically timed out for repeated spam.`,
                                userId:
                                    message.author.id,
                                moderatorId:
